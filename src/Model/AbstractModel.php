 ...
 * @subpackage  Omega\Database\Model
...
abstract class AbstractModel
{
     ...
     *
     * @var AbstractDatabaseAdapter $connection Holds the database connection.
     */
    protected AbstractDatabaseAdapter $connection;
     ...
     * @return static
     */
    public function setConnection( AbstractDatabaseAdapter $connection ) : static
    {
     ...
     *
     * @return AbstractDatabaseAdapter Return the current instance of AbstractDatabaseAdapter.
     */
